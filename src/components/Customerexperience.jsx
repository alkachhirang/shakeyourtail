  ...
  return (
    <div className='customer_bg_img py_customer' >
      ...
      <Container className='py_feature'>
        <h4 className='ff_roboto fs_48 fw-medium text-center text-white m-0 pb-1'>Features</h4>
        ...
        <Slider {...settings}>
          <div className='px_12'>
            <div className='feature_box1 cursor_pointer cardbox'>
              <FeatureSchedule />
          ...
          <div className='px_12'>
            <div className='feature_box2 position-relative cursor_pointer cardbox'>
          ...
          <div className='px_12'>
            <div className='feature_box3 cursor_pointer cardbox'>
              <Report />
          ...
          <div className='px_12'>
            <div className='feature_box4 cursor_pointer cardbox'>
              <Services />
              <h2 className='ff_roboto fs_20 fw-medium text-black m-0 pt-2'>Schedule</h2>
        ...
        <div className='d-flex justify-content-center mt_60'>
